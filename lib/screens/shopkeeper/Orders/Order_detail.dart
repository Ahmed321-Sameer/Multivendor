...
class Order_Detail extends StatefulWidget {
  String busines_name;
  String snapshot_id;
  Order_Detail({required this.busines_name, required this.snapshot_id});
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                child: Card(
                    ...
                    //     radius: 50,
                    //     child: Image.network(value["product_image"]),
                    //   ),
                    //   title: Text(value["product_name"]),
                    //   subtitle: Text(value["product_price"]),
                    //   trailing: Text(value["order status"]),
                    //   onTap: () {
                    //     cameradialog(value, snapshot.data!.size);
                    //   },
                    // ),
                    ),
              );
